...
class store {
    ...
    passForApi(i) {
        common.loading.show();
        approvalService.pass(this.resultDataList[i].strategyId, this.params.getType, this.resultDataList[i]).then(this.passForApiCallBack).catch(() => common.loading.hide())
    }
    ...
    rejectForApi(i) {
        common.loading.show();
        approvalService.reject(this.resultDataList[i].strategyId, this.params.getType, this.resultDataList[i]).then(this.rejectForApiCallBack).catch(() => common.loading.hide())
    }
