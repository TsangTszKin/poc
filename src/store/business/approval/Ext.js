 ...
 * @LastEditTime: 2019-03-13 11:40:14
 * @Description: 
 */
...
import TableAction from '@/components/business/approval/ext/TableAction';
...
const columns = [
    {
        ...
        title: '名称',
        dataIndex: 'extVarName',
        key: 'extVarName'
    }, {
        title: '标识',
        dataIndex: 'extVarCode',
        key: 'extVarCode',
        sorter: (a, b) => {
            return a.extVarCode.localeCompare(b.extVarCode)
        }
    }, {
        title: '版本',
        dataIndex: 'version',
...
class store {
    ...
    passForApi(i) {
        common.loading.show();
        approvalService.pass(this.resultDataList[i].extVarId, this.params.getType, this.resultDataList[i]).then(this.passForApiCallBack).catch(() => common.loading.hide())
    }
    ...
    rejectForApi(i) {
        common.loading.show();
        approvalService.reject(this.resultDataList[i].extVarId, this.params.getType, this.resultDataList[i]).then(this.rejectForApiCallBack).catch(() => common.loading.hide())
    }
