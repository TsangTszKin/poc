...
import { message, Row, Col, Spin, Descriptions } from 'antd';
...
class RulePanel extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (this.props.ruleId !== nextProps.ruleId) {
            this.getRuleById(nextProps.ruleId);
        }
    }
    getRuleById(id) {
    ...
    getInitDataList = () => {
        ...
        variableService.getEventSourceSelectList(true).then(res => {
            ...
            if (!common.isEmpty(this.props.ruleId)) {
                this.getRuleById(this.props.ruleId);
            } else {
