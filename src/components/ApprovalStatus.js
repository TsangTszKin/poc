            ...
            <div className="status" style={this.props.style}>
                {
                    (() => {
                        switch (this.props.status) {
                            case 0:
                                return <div><p className="status-label ready"></p><p className="status-name">审核中</p></div>
                            case 1:
                                return <div><p className="status-label online"></p><p className="status-name status-name-active">通过</p></div>
                            case 2:
