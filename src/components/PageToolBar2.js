/*
 * @Author: zengzijian
 * @Date: 2019-03-06 14:45:03
 * @LastEditors: zengzijian
 * @LastEditTime: 2019-08-14 16:27:35
 * @Description: 
 */
            ...
            <div className="pageToolBar-container" style={{ display: this.props.store.getShowToolBarType == 1 ? 'flex' : 'none' }} >
                <div style={{ flex: 1 }}>
                    ...
                    <div className="select-container" style={{ display: this.state.selectData.length > 0 && this.props.selectName ? 'block' : 'none' }}>
                        <Select value={this.props.store.getQuery.eventSourceId} style={{ width: 120 }} onChange={(value) => this.selectorChange('eventSourceId', value)}>
