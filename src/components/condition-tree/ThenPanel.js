 ...
 * @LastEditTime: 2019-08-22 15:31:40
 * @Description: 
 */
...
class TreePanel extends Component {
    ...
    updateTreeJsonCallBack = () => {
        this.props.updateConditionThen(toJS(ConditionThenStore.getConditionsAll));
        this.setState({
            treeJson: ConditionThenStore.getConditionsAll
        })
    }
    ...
    sub = (nodeKey) => {
        ...
        ConditionThenStore.subNode(nodeKey);
...
TreePanel.propTypes = {
    ...
    updateConditionThen: PropTypes.fun,//用于更新全部条件, 形参是完整的参数treeData
