 ...
 * @LastEditTime: 2019-08-22 11:22:14
 * @Description: 
 */
...
class Else extends Component {
    ...
    updateExpressionTree(value) {
        ...
        this.props.conditionElseStore.updateNodeData(this.props.nodeKey, 'computeExpressionVO', value);
        this.saveData.computeExpressionVO = value;

        this.props.updateConditionElse(this.props.conditionElseStore.getConditionsAll);
    ...
    changeData(name, value, nodeKey) {
        ...
        switch (name) {
            case 'varCode'://改变变量时，把fixValue清空
                this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'fixedValue', '');
                this.saveData.fixedValue = '';
                break;
            case 'type'://改变变量类型的时候，把等号右边的所有值清空
                this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'varType', '');
                this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'varDataType', '');
                this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'varCode', '');
                this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'fixedValue', '');
                ...
                if (value === 3) {//计算类型
                    this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'computeExpressionVO', computeExpressionVODemo);
            ...
            case 'defaultValue':
                ...
                this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'fixedValue', this.saveData.fixedValue);
                break;
            case 'rtqVarId'://切换 （执行方法）的查询方法（实时查询变量），把参数清空
                if (this.saveData.actionType == 1) {
                    this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'parameterId', '');
                    this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'parameterName', '');
                    this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'parameterCode', '');
                    this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'parameterDefaultValue', '');
                    this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'parameterType', '');
                ...
                if (this.saveData.actionType === 0) {//切换 （参数赋值）的参数变量，把等号右边清空
                    if (this.saveData.type == 1) {//变量
                        if (this.saveData.varType == 3) {
                            this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'rtqVarId', '');
                        ...
                        this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'fixedValue', '');
                        this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'varDataType', '');
                        this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'varName', '');
                        this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'varDefaultValue', '');
                        this.saveData.varType = '';
                        this.saveData.varCode = '';
                        this.saveData.fixedValue = '';
                        this.saveData.varDataType = '';
                        ...
                        this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'type', 0);
                        this.saveData.type = 0;

                        this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, 'computeExpression', computeExpression);
        ...
        if (name !== 'defaultValue') {
            ...
            this.props.conditionElseStore.updateNodeData(!common.isEmpty(nodeKey) ? nodeKey : this.props.nodeKey, name, value);
        }

        this.props.updateConditionElse(this.props.conditionElseStore.getConditionsAll);
        // console.log("tree changeData this.props.conditionElseStore.getConditionsAll", this.props.conditionElseStore.getConditionsAll);
        this.props.verifyConditionTreeFinish();
