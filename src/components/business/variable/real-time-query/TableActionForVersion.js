/*
 * @Author: zengzijian
 * @Date: 2019-07-02 09:14:35
 * @LastEditors: zengzijian
 * @LastEditTime: 2019-08-12 17:33:55
 * @Description: 
 */
    ...
    render() {
        return (
            <div className="table-action">
                ...
                {/* <span class="iconfont iconxiangqing" title='详情' onClick={() => {
                    this.props.history.push(this.props.detailPath);
                }} style={style.icon}></span> */}
                {
                    publicUtils.isAuth("business:strategy:rule:delete") ?
                        <Popconfirm title="是否确定删除?" onConfirm={() => { this.props.deleteRTQVersion(this.props.dataId) }} onCancel={() => { }} okText="确定" cancelText="取消">
