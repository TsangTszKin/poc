 ...
 * @LastEditTime: 2019-05-17 12:08:04
...
@inject('store')
@observer
class FormButtonGroupForEventSource extends Component {
    constructor(props) {
        super(props);
        this.state = {
            style: {
    ...
    render() {
        return (
            <div style={this.state.style} id="form-button-group">
                ...
                {
                    this.props.isShowSaveBtn ? <Button style={{ marginRight: '24px' }} type="primary" onClick={this.props.saveCallBack} >保存并下一步</Button> : ''
                }
...
FormButtonGroupForEventSource.propTypes = {
...
FormButtonGroupForEventSource.defaultProps = {
    cancelCallBack: () => { },
    saveCallBack: () => { },
    isFixed: false,
...
export default FormButtonGroupForEventSource;